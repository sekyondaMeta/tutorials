...
## [https://pytorch.org/tutorials](https://pytorch.or/tutorials)
...
4. For Tutorials (except if it is a prototype feature), create a thumbnail in the [index.rst file](https://github.com/pyrch/tutorials/blob/main/index.rst) using a command like `.. customcarditem:: beginner/your_tutorial.html`. For Recipes, create a thumbnail in the [recipes_index.rst](https://github.com/pyrch/tutorials/blob/main/recipes_source/recipes_index.rst)
